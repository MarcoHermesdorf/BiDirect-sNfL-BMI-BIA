...
list.of.packages <- c("haven" ,"psych", "reshape2", "pillar", "ggplot2", "GPArotation", "lmtest", "nortest", "skimr", "DT", "table1", "corrplot", "jtools", "DescTools", "psych", "lmerTest", "afex", "plyr", "lattice", "parameters", "cNORM", "glmmTMB", "sjPlot", "MuMIn", "MASS")
